...
const TEACHERS_KEY = "teachers_list";
...
const AdminNotification = () => {
    ...
    useEffect(() => {
        ...
        setNotifications(storedNotifications.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp)));
    }, []);
    ...
    const handleSend = (e) => {
        ...
        const newNotification = {
            ...
            recipient: {
                ...
                id: formData.recipientType === "individual" ? formData.recipientId : null
            },
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                ...
                                                {teachers.map(teacher => (
                                                    <option key={teacher.teacherId} value={teacher.teacherId} className="bg-gray-900">
            ...
            >
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        <span className={`px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded-full border ${note.recipient.type === 'all' ? 'bg-purple-500/10 text-purple-400 border-purple-500/20' : 'bg-blue-500/10 text-blue-400 border-blue-500/20'}`}>
                            {note.recipient.type === 'all' ? 'Broadcast' : `To: ${note.recipient.id}`}
                        </span>
